...
* __Parámetros__ son variables que definen el modelo entrenado mediante aprendizaje. Los parámetros son directamente modificados por el algoritmos de aprendizaje basado en los datos de entrenamiento. Ej, la pendiente y la ordenada de una recta en regresión lineal simple. 
<br>

* __Hiperparámetros__ son entradas de un algoritmo de ML que influencian la performance del modelo. No pertenecen a los datos de entrenamiento y no pueden ser aprendidos mediante el algoritmo de ML. Generalmente hacemos una búsqueda de hiperparámetros (en grilla o de manera aleatoria).
Ej: profundidad de un árbol en árboles de decisión, el K óptima en KNN.


.footnote[<sup>*</sup> Machine Learning Engineering]
...
.footnote[<sup>*</sup> http://www2.math.uu.se/~thulin/mm/breiman.pdf]
...
Cuando entrenamos nuestro modelo de ML, al estar trabajando en situaciones estocásticas (probabilísticas), vamos a tener dos fuentes de error:
...
A su vez, disponemos de un modelo en el cual las clases no coinciden 100%
