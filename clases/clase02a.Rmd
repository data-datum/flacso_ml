...
## ¿Qué sucede cuando tenemos clases desbalanceadas?
...
1. Cambiar la métrica de evaluación del modelo. 

2. Darle un determinado peso a una clase en particular, atendiendo al desbalanceo. 

3. Balancearlos haciendo un:
* **Undersampling.** Es una buena opción si tenemos muchos datos. 
* **Oversampling.** Creamos datos sintéticos a partir de los que ya tenemos. 
...
```{r echo=FALSE, out.width = '100%',  fig.align='center'}
knitr::include_graphics("img/unders-overs.png")
```
...
```{r echo=FALSE, out.width = '100%',  fig.align='center'}
knitr::include_graphics("img/random-under.png")
```
...
```{r echo=FALSE, out.width = '100%',  fig.align='center'}
knitr::include_graphics("img/random-over.png")
```
...
También podemos hacer under y oversampling mediante técnicas específicas que atiendan a criterios particulares. 
...
* En R tenemos opciones de undersampling y de oversampling. 

### Undersampling


```{r echo=FALSE, out.width = '90%',  fig.align='center'}
knitr::include_graphics("img/under-R.png")
```




.footnote[https://github.com/tidymodels/themis]
...
```{r echo=FALSE, out.width = '90%',  fig.align='center'}
knitr::include_graphics("img/over-R.png")
```
